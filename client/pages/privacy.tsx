import { Heading, ListItem, UnorderedList, Text, Link } from "@chakra-ui/react";
      ...
      <Page>
        ...
        <Page.Content>
          <Text my={8}>
            ...
            <BrandText>SimplyShift</BrandText>&#39;s policy to respect your
            ...
            our website,{" "}
            <a href="https://simplyshift.app">https://simplyshift.app</a>, and
            other sites we own and operate.{" "}
          </Text>
          <Text my={8}>
            This policy is effective as of 9 June 2021 and was last updated on 9
            June 2021.{" "}
          </Text>
          <Heading mt={5} mb={3} as="h3" size="lg">
          ...
          <Heading mt={5} mb={3} as="h3" size="md">
            Log Data
          </Heading>
          <Text my={8}>
          ...
          <Text my={8}>We may disclose personal information to: </Text>
          <UnorderedList>
            <ListItem>
          ...
          <Link href="mailto:simlyshift@tinyhive.dev">
            simplyshift@tinyhive.dev
          </Link>
        </Page.Content>
      </Page>
    </PageWrapper>
