...
class CalendarContainer extends Component {
  ...
  onDeleteEntry = (id) => {
    this.props
      ...
      .then(() => this.props.getData(SHIFT_ENTRIES_PATH, shiftEntriesFetched))
    ...
    return (
      <>
        <header className="main-calendar-header">
          ...
          <p>
            Here you can view your shift calendar, see who is next on your
            hitlist, and when you plan to quit your job, all in one neat place!
          </p>
        </header>
