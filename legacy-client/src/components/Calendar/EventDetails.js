    ...
    >
      <Card.Body>
        ...
        <Card.Subtitle className="mb-2 text-muted">
          ...
          since the 1500s, when an unknown printer tookg software orem Ipsum is
          simply dummy text of the printing and typesetting industry. Lorem
          Ipsum has been the industry's standard dummy text ever since the
          1500s, when an unknown printer tookg software like Aldus PageMaker
          including versions of Lorem orem Ipsum is simply dummy text of the
          printing and typesetting industry. Lorem Ipsum has been the industry's
          standard dummy text ever since the 1500s, when an unknown printer
          tookg software like Aldus PageMaker including versions of Lorem like
        ...
        <Card.Text>
          {startDate === endDate && (
            <>
              ...
              <br />
              <Moment format="hh:mm a">{event.start}</Moment> -{" "}
